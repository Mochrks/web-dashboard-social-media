    ...
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="p-6 text-center hover:border-primary/30 transition-smooth cursor-pointer">
          ...
          <button className="text-primary text-sm font-semibold hover:underline">Start Chat</button>
        </Card>
        ...
        <Card className="p-6 text-center hover:border-primary/30 transition-smooth cursor-pointer">
          ...
          <button className="text-primary text-sm font-semibold hover:underline">Send Email</button>
        </Card>
