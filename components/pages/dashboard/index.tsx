...
import { RecentPosts } from "@/components/section/recent-posts";
import { UserActivity } from "@/components/section/user-activity";
        ...
        <main className="container mx-auto p-4 md:p-6 space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">5,123</div>
