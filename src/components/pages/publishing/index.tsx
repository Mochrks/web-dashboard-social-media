  ...
  return (
    <div className="flex flex-col min-w-0">
      ...
      <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Publishing Calendar</h1>
      ...
      <div className="flex flex-col xl:flex-row gap-8">
                  ...
                  >
                    <span
                      className={`text-sm font-medium ${
                        isToday ? "text-primary font-bold" : !isCurrentMonth ? "text-slate-400" : ""
                      }`}
                    >
        ...
        <aside className="w-full xl:w-80 space-y-6">
          ...
          {/* AI Suggestion */}
          <Card className="p-4 bg-lavender dark:bg-primary/10 border-primary/20">
