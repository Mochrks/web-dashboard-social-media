...
const initialEvents = [
  {
    ...
    description: "Annual tech conference featuring the latest in AI and blockchain.",
  },
  {
    id: 2,
    title: "Product Launch",
    date: new Date(2023, 5, 12),
    description: "Launching our new flagship product with live demonstrations.",
  },
  {
    id: 3,
    title: "Networking Mixer",
    date: new Date(2023, 5, 18),
    description: "Evening of networking with industry professionals and potential clients.",
  },
];
...
export function EventManagement() {
  ...
  const handleAddEvent = () => {
    if (editingEvent !== null) {
      setEvents(
        events.map((event) => (event.id === editingEvent ? { ...event, ...newEvent } : event))
      );
